...
from every_model_architecture import Neural_combining
from every_model_architecture import FFDNet_mnist_ensemble_neural
...
model = FFDNet_mnist_ensemble_neural(model1, model2)
print(f"Architecture model 1 : {model1}")
print(f"Architecture model 2 : {model2}")

print(f"FFDNet_mnist_ensemble_neural architecture: {model}")
...
model_path = f'trained_models/FFDNet_mnist_ensemble_neural_{num_epochs}_epochs_{noise_std_vector}_noise_std_vector.pth'
optimizer_path = f'trained_models/optimizer_FFDNet_mnist_ensemble_neural{num_epochs}_epochs_{noise_std_vector}_noise_std_vector.pth'
