# This file is to train the map_var_ffdnet_inspired_mnist model.
# It is the same model as mnist_ffdnet_inspired but know the noise map can be different for each image.
# This is to improve the ability of the model to denoise images with different noise levels.
